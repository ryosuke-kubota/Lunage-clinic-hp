...
export const equipmentData: Record<string, Category> = {
  ...
  "sofwave": {
    title: "ソフウェーブ",
    description: "超音波による非侵襲的リフトアップ治療",
    treatments: [
      {
        name: "ソフウェーブ顔/首",
        equipment: "ソフウェーブ",
